...
#SBATCH --job-name=mixed_zero_spawn
#SBATCH --output=mixed_zero/output/logs/mixed_zero_spawn.%j.out
#SBATCH --error=mixed_zero/output/errors/mixed_zero_spawn.%j.err
